...
public abstract class AbstractStringMatchTest {
	...
	public void testMatchAtStart() {
		assertEquals(0,
				matcher.firstMatch("Algorithmen und Datenstrukturen", "Algorithmen"));
	}

	@Test(timeout = 1000)
	public void testMatchAtEnd() {
		assertEquals(20,
				matcher.firstMatch("Datenstrukturen und Algorithmen", "Algorithmen"));
	}

	@Test(timeout = 1000)
	public void testNoMatch2() {
		assertEquals(-1,
				matcher.firstMatch("aaaaaaaaaaaaaaaaaa", "aaab"));
	}

	@Test(timeout = 1000)
	public void testNoMatch() {
		assertEquals(-1,
				matcher.firstMatch("Das Modul Algd1 findet statt.", "Algorithmen"));
	}

	@Test(timeout = 1000)
	public void testFindFirstMatch() {
		assertEquals(8, matcher.firstMatch(
				"Es gibt Algorithmen1 und Algorithmen2.", "Algorithmen"));
	}
	...
	public void testSentence1() {
		assertEquals(31,
				matcher.firstMatch("hin oder her, suchen ist nicht schwer!", "schwer"));
	}

	@Test(timeout = 1000)
	public void testSentence2() {
		assertEquals(-1, matcher.firstMatch(
				"hin oder her, suchen ist nicht schwer!", "hin und her"));
	}

	@Test(timeout = 1000)
	public void testSentence3() {
		assertEquals(31,
				matcher.firstMatch("Manch kühler Lehrer wird immer leerer.", "leerer"));
	}
